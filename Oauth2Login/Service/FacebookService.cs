...
namespace Oauth2Login.Service
{
    public class FacebookService : BaseOauth2Service
    {
        ...
        public override string BeginAuthentication()
        {
            ...
            _oauthUrl = "https://www.facebook.com/v2.0/dialog/oauth?" + qstring;
        ...
        {
            string profileUrl = "https://graph.facebook.com/me?fields=id,name,email,first_name,last_name&access_token=" + _client.Token;
